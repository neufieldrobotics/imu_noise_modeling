...
if(imu_params.Accelerometer.BiasInstability == 0)
    ...
    for i = 1:3
        np.acc(:,i) = pink_noise_gen(imu_params.Accelerometer.BiasInstability(i),...
                                     imu_params.Accelerometer.factor(i),...
                                     imu_params.Accelerometer.tau1(i),...
                                     imu_params.Accelerometer.tau2(i),...
                                     M,del_t);
                                 
%         np.acc(:,i) = pink_noise_gen1(imu_params.Accelerometer.sigma(i),...
%                                      imu_params.Accelerometer.tau1(i),...
%                                      imu_params.Accelerometer.tau2(i),...
%                                      M,del_t);
    end
...
if(imu_params.Gyroscope.BiasInstability == 0)
    ...
    for i = 1:3
        ...
        np.gyro(:,i) = pink_noise_gen(imu_params.Gyroscope.BiasInstability(i),...
                                     imu_params.Gyroscope.factor(i),...
                                     imu_params.Gyroscope.tau1(i),...
                                     imu_params.Gyroscope.tau2(i),...
                                     M,del_t);
                                 
%         np.gyro(:,i) = pink_noise_gen1(imu_params.Gyroscope.sigma(i),...
%                              imu_params.Gyroscope.tau1(i),...
%                              imu_params.Gyroscope.tau2(i),...
%                              M,del_t);
    end
