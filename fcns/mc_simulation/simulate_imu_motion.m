function [t,accelSamples,gyroSamples,varargout] = simulate_imu_motion(imu_params,sim_params)
...
disp('Displaying gyro and acc params that are sent to imu object');
disp(acc_params);
disp(gyro_params);
